...
extension ChannelPipeline.SynchronousOperations {
  ...
  package func configureGRPCServerPipeline(
    ...
    http2HandlerConnectionConfiguration.controlFrameRateLimit.maximumCount =
      http2Config.controlFrameRateLimit.maximumCount
    http2HandlerConnectionConfiguration.controlFrameRateLimit.windowLength = TimeAmount(
      http2Config.controlFrameRateLimit.window
    )
