...
installed SwiftPM does not find swift-testing's macro plugin, and the build fails
...
It brings up a profile called `e2e-runtime`, with its own ports, state directory
