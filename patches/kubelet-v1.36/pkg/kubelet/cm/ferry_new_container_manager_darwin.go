...
// between minors. v1.36 threads a context through NewContainerManager; nothing
// in the darwin implementation blocks, so it is accepted and dropped, which is
// what upstream's own unsupported variant does.
package cm
